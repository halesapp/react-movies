...
const App = () => {
    ...
    const toggleExcludeDisc = () => {setExcludeDisc(prevState => !prevState)}
    const toggleImgRes = () => {setImgHighRes(prevState => !prevState)}
    const toggleAnimateSearch = () => {setAnimateSearch(prevState => !prevState)}
    ...
    const downloadDB = function () {
        ...
        link.setAttribute('download', 'movie-database.json');
        link.click();
        link.remove()
    }
      ...
      <Suspense fallback={<LoadingScreen message={"Loading display..."}/>}>
          <div className="app">
              <div className="controls-bar">
                  ...
                  <ButtonControls movie={searchTitle} db={db} random={random} toggleModal={toggleModal} setSearchTitle={setSearchTitle}/>
              </div>
              ...
              <OptionsModal visible={modalVisible}
                            ...
                            toggleAnimateSearch={toggleAnimateSearch}
                            animateSearch={animateSearch}
